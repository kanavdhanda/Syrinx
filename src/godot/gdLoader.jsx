...
export default function GdLoader(props) {
    ...
    useEffect(() => {
        ...
        // addScript(`/level/${GODOT_CONFIG.name}.js`);
    ...
    return (
        <div className="godot-container" style={{ width: '100vw', height: '100vh', position: 'relative' }}>
            <canvas
                ref={canvasRef}
                id="canvas"
                style={{ display: 'block' }}
            ...
            {loading && !error && (
                <div className="loading-overlay flex items-center justify-center flex-col">
            ...
            {error && (
                <div className="error-overlay">
                    ...
                    <div className="error-message">Please Send A Screenshot to one of moderators  😔</div>
                </div>
            )}
        </div>
    );
